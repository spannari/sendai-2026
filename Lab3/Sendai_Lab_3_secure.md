...
1. Open **Larix Broadcaster** on your phone. Click the wheel to access settings. ![Larix settings](./img_org/settings.jpeg)

2. Click the **plus-symbol** to create a new connection. ![Create new connection](./img_org/new_connection.jpeg)
    ![Choose connection](./img_org/connect.jpeg)
3. Fill in the following details:
    - Name: [name for your connection]
    - URL: `rtmp://195.148.104.124:1935/Sendai/[YOUR_STREAM_NAME_HERE]` Choose a unique name for your stream, so it differs from other groups. **Note:** URL is case-sensitive.
    - Target type: RTMP authorization
    - Login `sendai` and password `metro26`.
      ![Connect settings 1](./img_org/connect_settings1.jpeg)
      ![Connect settings 2](./img_org/connect_settings2.jpeg)
...
4. Tap the Back-button, until you get back to the screen where you can choose the connections. Choose your newly created connection, and hit back to get back on the recording screen.
    ![Choose your connection](./img_org/connections.jpg)

### 3. Verification (Wowza & VLC)

1. Open your favorite browser, and open a new **private** window. Login to the Wowza UI <http://streamer.metropolia.fi:8088>. Username and password are the same as with setting up the stream.
   ![Wowza login](./img_org/streamer.png)
